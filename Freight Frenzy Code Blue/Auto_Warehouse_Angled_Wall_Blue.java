...
@Autonomous(name = "Auto_Warehouse_Angled_Wall_Blue")
public class Auto_Warehouse_Angled_Wall_Blue extends LinearOpMode {
  ...
  private void drive(double power, double leftInches, double leftInches2, double rightInches, double rightInches2) {
   ...
   private void score(int armPos) {
    ...
    //       //run the intake backwards to reset a failed score
    //       intake.setPower(0.3);
    //   }
    ...
    while (opModeIsActive() && runtime.seconds() > 3 && runtime.seconds() <= 4) {
      ...
      armDrive.setPower(0.5);
                 ...
                 while (opModeIsActive() && runtime.seconds() > 5 && runtime.seconds() <= 6) {
