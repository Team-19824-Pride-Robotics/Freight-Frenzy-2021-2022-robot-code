...
@Autonomous(name = "Auto_Warehouse_Wall_Blue")
public class Auto_Warehouse_Wall_Blue extends LinearOpMode {
...
private void duck(double duckSpeed) {
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
       ...
       //segment 1 - drive to the markers
       drive(0.3, 6, 6, 6, 6);
       
       //segment 2 - look for the cup and record its value in a variable
     int cup = lookForCup();   
     if (cup > 1100) {
            if (cup > 1250) {
              toHub = 3.1;
