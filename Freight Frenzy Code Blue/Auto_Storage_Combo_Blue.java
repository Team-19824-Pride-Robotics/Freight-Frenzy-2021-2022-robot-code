...
@Autonomous(name = "Storage_Combo_Blue")
public class Auto_Storage_Combo_Blue extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
     ...
     if (cup > 1100) {
      ...
      //segment 10 - back up into storage unit 
