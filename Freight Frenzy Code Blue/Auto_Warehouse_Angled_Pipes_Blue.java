...
@Autonomous(name = "Auto_Warehouse_Angled_Pipes_Blue")
public class Auto_Warehouse_Angled_Pipes_Blue extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    if (cup > 1100) {
      ...
      //segment 5 - score the pre-load at the pre-determined level
       ...
       //segment 7 - strafe left towards shipping hub
