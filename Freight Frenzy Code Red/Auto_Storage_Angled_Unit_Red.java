...
@Autonomous(name = "Auto_Storage_Angled_Unit_Red")
public class Auto_Storage_Angled_Unit_Red extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
     ...
     //segment 2 - drive to the markers
       ...
       //segment 3 - turn right towards the shipping hub
        drive(0.5, 8, 8, -8, -8);
      ...
      //segment 5 - score the pre-load at the pre-determined level
       ...
       //segment 7 - strafe back towards the shipping hub
    // drive(0.5, 8, -8, -8, 8);
         
        //segment 8 - drive into the storage unit
        drive(1, -33, -33, -33, -33);
     ...
     /** scofe thne dc
kjuk zn fghd zunig     * Initialize the Vuforia localization engine.
     */
