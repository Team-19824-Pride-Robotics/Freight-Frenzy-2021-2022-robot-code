...
@Autonomous(name = "Auto_Storage_Combo_Red")
public class Auto_Storage_Combo_Red extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
     ...
     //segment 2 - drive to the markers
      ...
      //segment 3 - strafe right
        drive(0.5, -32, 32, 32, -32);
        
      //segment 4 - drive forward to hub
        drive(0.4, toHub, toHub, toHub, toHub);
        
      //segment 5 - score the pre-load at the pre-determined level
        score(cup);
     
      //segment 6 - strafe left to storage unit
        drive(0.5, 50, -50, -50, 50);
       
      //segment 7 - turn around to face carousel 
        drive(0.7, 42, 42, -42, -42);
        
      //segment 8 - drive forward to carousel
        drive(0.7, toDuck, toDuck, toDuck, toDuck);
      
      //segement 9 - score duck  
        duck(-0.3);
